import * as apis from '@agreejs/taro-h5'
...
it('should work!', function () {
  const code = `
    import Taro, { setStorage, initPxTransform, param } from '@agreejs/taro-h5';
...
it('should move static apis under "Taro"', function () {
  const code = `
    import { noop } from '@agreejs/taro-h5';
    noop;
    noop();
  `
...
it('should not import taro duplicatly', function () {
  const code = `
    import { Component } from "@agreejs/taro-h5";
    import Taro from '@agreejs/taro-h5';
    Component
...
it('should support rename of imported names', function () {
  const code = `
  // import { inject as mobxInject, observer as mobxObserver } from '@agreejs/mobx'
  import { Component as TaroComponent } from "@agreejs/taro-h5";
