...
export const UPDATE_PACKAGE_LIST = [
  ...
  '@agreejs/react',
  '@agreejs/router',
  '@agreejs/runner-utils',
  '@agreejs/runtime',
  '@agreejs/service',
  '@agreejs/webpack-runner',
  '@agreejs/with-weapp',
  '@agreejs/taroize',
  '@agreejs/plugin-platform-weapp',
  '@agreejs/plugin-platform-alipay',
  '@agreejs/plugin-platform-swan',
  '@agreejs/plugin-platform-tt',
  '@agreejs/plugin-platform-qq',
...
export const taroJsComponents = '@agreejs/components'
export const taroJsQuickAppComponents = '@agreejs/components-qa'
export const taroJsFramework = '@agreejs/taro'
export const taroJsRedux = '@agreejs/redux'
export const taroJsMobx = '@agreejs/mobx'
export const taroJsMobxCommon = '@agreejs/mobx-common'
