...
import { AppConfig, Config } from '@agreejs/taro'
import { RecursiveTemplate, UnRecursiveTemplate } from '@agreejs/shared'
import {
  resolveMainFilePath,
  readConfig,
  isEmptyObject,
...
export default class TaroMiniPlugin {
  ...
  pageLoaderName = '@agreejs/taro-loader/lib/page'
    ...
    compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation, { normalModuleFactory }) => {
      ...
      compilation.hooks.normalModuleLoader.tap(PLUGIN_NAME, (loaderContext, module:/** TaroNormalModule */ any) => {
        ...
        if (module.miniType === META_TYPE.ENTRY) {
          const loaderName = '@agreejs/taro-loader'
          ...
          if (!isLoaderExist(module.loaders, loaderName)) {
            module.loaders.unshift({
              loader: isBuildPlugin ? '@agreejs/taro-loader/lib/native-component' : loaderName,
              options: {
                framework,
                name: module.name,
          ...
          const loaderName = isBuildPlugin ? '@agreejs/taro-loader/lib/native-component' : '@agreejs/taro-loader/lib/component'
          if (!isLoaderExist(module.loaders, loaderName)) {
            module.loaders.unshift({
              loader: loaderName,
              options: {
