...
import { PLATFORMS, FRAMEWORK_MAP, taroJsComponents } from '@agreejs/helper'
...
export default (appPath: string, mode, config: Partial<IBuildConfig>): any => {
  ...
  plugin.providerPlugin = getProviderPlugin({
    window: ['@agreejs/runtime', 'window'],
    document: ['@agreejs/runtime', 'document'],
    navigator: ['@agreejs/runtime', 'navigator'],
    requestAnimationFrame: ['@agreejs/runtime', 'requestAnimationFrame'],
    cancelAnimationFrame: ['@agreejs/runtime', 'cancelAnimationFrame'],
    Element: ['@agreejs/runtime', 'TaroElement'],
    SVGElement: ['@agreejs/runtime', 'TaroElement']
  })
