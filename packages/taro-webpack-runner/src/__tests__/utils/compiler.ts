  ...
  webpackChain.merge({
    resolve: {
      alias: {
        ...
        '@agreejs/shared': path.resolve(__dirname, '../mocks/taro-shared'),
        '@agreejs/taro-h5': path.resolve(__dirname, '../mocks/taro-h5'),
        '@agreejs/components$': path.resolve(__dirname, '../mocks/taro-components'),
        '@agreejs/components/dist-h5/vue': path.resolve(__dirname, '../mocks/taro-components'),
        '@agreejs/components/dist-h5/vue3': path.resolve(__dirname, '../mocks/taro-components'),
        '@agreejs/components/loader': path.resolve(__dirname, '../mocks/taro-components'),
        '@agreejs/components/dist/taro-components/taro-components.css': path.resolve(__dirname, '../mocks/taro-components.css'),
