import { isFunction, isArray, ensure, capitalize, toCamelCase, internalComponents, hasOwn, isBooleanStringLiteral } from '@agreejs/shared'
...
import type { AppConfig as Config } from '@agreejs/taro'
