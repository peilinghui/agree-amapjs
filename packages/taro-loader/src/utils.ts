...
`,
    ...
    extraImportForWeb: `
require('@agreejs/components/dist-h5/vue')
`
  },
  vue3: {
    importFrameworkStatement: `
...
`,
    ...
    isNeedRawLoader: true,
    extraImportForWeb: `
import { initVue3Components } from '@agreejs/components/dist-h5/vue3'
`,
...
`,
    ...
    compatComponentImport: 'import { PullDownRefresh } from "@agreejs/components"',
