...
export default function (this: webpack.loader.LoaderContext, source: string) {
  ...
  const thisLoaderIndex = loaders.findIndex(item => normalizePath(item.path).indexOf('@agreejs/taro-loader/lib/page') >= 0)
...
if (typeof PRERENDER !== 'undefined') {
  ...
  return `import { createPageConfig } from '@agreejs/runtime'
