...
import { normalizePath } from '@agreejs/helper'
...
export default function (this: webpack.loader.LoaderContext) {
  ...
  const thisLoaderIndex = loaders.findIndex(item => normalizePath(item.path).indexOf('@agreejs/taro-loader/lib/native-component') >= 0)
...
if (typeof PRERENDER !== 'undefined') {
  ...
  return `import { createNativeComponentConfig } from '@agreejs/runtime'
