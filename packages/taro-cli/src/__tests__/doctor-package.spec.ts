...
const baseModules = [
  {
    moduleName: '@agreejs/components',
    latest: cliVersion,
    installed: cliVersion,
    isInstalled: true
  },
  {
    moduleName: '@agreejs/runtime',
    latest: cliVersion,
    installed: cliVersion,
    isInstalled: true
  },
  {
    moduleName: '@agreejs/taro',
    latest: cliVersion,
    installed: cliVersion,
    isInstalled: true
  },
  {
    moduleName: '@agreejs/mini-runner',
    latest: cliVersion,
    installed: cliVersion,
    isInstalled: true
  },
  {
    moduleName: '@agreejs/webpack-runner',
    latest: cliVersion,
    installed: cliVersion,
    isInstalled: true
  },
...
describe('package validator of doctor', () => {
  ...
  it('should report uninstalled modules', async () => {
    ...
    const uninstalledTaroPkg = '@agreejs/components'
    const couldUpdateTaroPkg = '@agreejs/runtime'
    const inconsistentTaroPkg = '@agreejs/taro'
  ...
  it('should report outdate taro modules', async () => {
    const moduleA = '@agreejs/components-rn'
    const moduleB = '@agreejs/components-qa'
    getMocked.mockReturnValue([
      ...baseModules,
      {
        moduleName: moduleA,
